...
def showStats():
    ...
    std.addstr(2, 0, "%.2f \t %.2f \t %.2f" %(robotTwist.linear.x,robotTwist.linear.y,robotTwist.linear.z))
    std.addstr(4,0,"Angular:")
    std.addstr(5, 0, "%.2f \t %.2f \t %.2f" %(robotTwist.angular.x,robotTwist.angular.y,robotTwist.angular.z))
    std.addstr(7,0,"Actual Position:")
    std.addstr(8, 0, "%.2f \t %.2f \t %.2f" %(robotOdom.pose.pose.position.x,robotOdom.pose.pose.position.y,robotOdom.pose.pose.position.z))
